...
# Multiply 6 by 6
6*6
# Divide 9 by 3.142, or pi rounded to 3 decimal places
9/3.142
...
myLogicalVector <- c(F, T, FALSE, TRUE)
str(myLogicalVector)
...
myCharVector <- c("hey", "hi", "hello", "hiii")
str(myCharVector)
...
# The column that was previously called "vector_character" is renamed to "qbName". 
